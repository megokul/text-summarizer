...
class ModelTrainer:
    ...
    def _save_model_and_tokenizer(self, model, tokenizer):
        ...
        logger.info("Model and tokenizer successfully saved.")
    ...
    def train(self) -> None:
        ...
        try:
            ...
            # === Extra: Safety checks for split size vs. batch size ===
